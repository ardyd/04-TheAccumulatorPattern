...
def run_test_factorial():
    ...
    print('Test 4 expected (from hand): ', answer_by_hand)
    print('       actual (from my code): ', answer_from_my_code)
...
# Test 2:
    expected = 1
    answer = count_cosines_from(3, 3, -1)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 1
    answer = count_cosines_from(3, 4, -0.75)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 1
    answer = count_cosines_from(4, 5, .27)
    ...
    # Test 6:
    expected = 3
    answer = count_cosines_from(6, 9, -0.16)
