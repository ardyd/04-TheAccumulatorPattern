...
def run_test_sum_more_cosines():
    ...
    # Test 2:
    expected2 = -1.77612  # This is APPROXIMATELY the correct answer.
    answer2 = sum_more_cosines(2, 5)
    print('Test 2 expected:', expected2, '(approximately)')
    print('       actual:  ', answer2)

    # Test 3:
    expected3 = 1.54030  # This is APPROXIMATELY the correct answer.
    answer3 = sum_more_cosines(0, 1)
